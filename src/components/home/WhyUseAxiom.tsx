...
export const WhyUseAxiom: React.FC = () => {
  const features = [
    {
      title: 'Decentralized Timelock Escrow',
      desc: 'Smart contract and 2-of-2 secret sharing guarantee sealed bids remain locked until the deadline.',
    },
    {
    ...
    {
      title: 'End-to-End Cryptographic Sealing',
      desc: 'AES-256-GCM encryption with HMAC SHA-256 tamper verification on all bids.',
    },
    {
      title: 'Periodic STQC & Smart Contract Audits',
      desc: 'System audited for formal cryptographic correctness, smart contract security, and compliance.',
    },
    {
      title: 'NTP & Blockchain Time Verification',
      desc: 'Dual time synchronization prevents premature unsealing and bid sniping.',
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          <div className="lg:col-span-4 flex flex-col items-start text-left gap-2 border-b lg:border-b-0 lg:border-r border-slate-200 pb-6 lg:pb-0 lg:pr-8">
            ...
            <p className="text-xs text-slate-500 leading-relaxed mt-2">
              The Axiom Cryptographic Procurement Portal ensures maximum transparency, mathematical fairness, and tamper-proof security in government bidding.
            </p>
          </div>
...
export const WhyUseGeM = WhyUseAxiom;
